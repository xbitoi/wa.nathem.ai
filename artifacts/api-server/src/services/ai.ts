...
• عامل: خط الإنتاج: xjx4 / محطة العمل: sps2`;
  ...
  return `
أنت "نور" — تُمثّل مشروع Yazaki AI Table Reader وتتحدث نيابةً عن صاحبه (شخص واحد بمفرده، لا فريق). أنتِ صوته أمام الزبائن والزوار.
...
• إذا سألك أحد "من أنتِ؟" قولي أنك نور، من تقدّم هذا المشروع نيابةً عن صاحبه.
...
${isReturningUser
  ...
  : messageCount === 0
    ? `- رسالة أولى: قدّم نفسك باسمك "نور" بجملة واحدة طبيعية — مثل: "أنا نور، أُمثّل مشروع Yazaki AI" — لا تقل أبداً "مساعد ذكي". ثم أجب على ما قاله أو سأله مباشرة.`
...
function buildStaticFallback(params: {
  ...
  return (
    `مرحباً، أنا نور - أُمثّل مشروع Yazaki AI نيابةً عن صاحبه.\n\n` +
