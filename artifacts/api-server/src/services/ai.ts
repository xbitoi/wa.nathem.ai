...
مثال صحيح: "يمكنك رؤية ذلك مباشرة على ${publicLink || 'رابط التطبيق'}"
مثال صحيح: "التطبيق متاح الآن على ${publicLink || 'رابط التطبيق'} — جرّبه"
مثال خاطئ: "رابط التطبيق: [رابط]" — هذا جاف ومنفصل.
