...
💡 *استكشف اكثر:*
  ...
  ❸  ${demoVideoUrl ? "شاهد الفيديو التوضيحي للتطبيق 🎥" : "[اقتراح سياقي ثالث — ميزة أو جانب لم يُذكر بعد]"}
...
• ❸ ثابت — إذا كان رابط الفيديو موجوداً: "شاهد الفيديو التوضيحي للتطبيق 🎥" — إذا ردّ المستخدم بـ ❸ أو "3": أرسل [SEND_DEMO_VIDEO] في ردك.
